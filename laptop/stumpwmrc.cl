...
(define-key *root-map* (kbd "M-less") "gnext")
...
(define-key *root-map* (kbd "less") "terminal")
(define-key *root-map* (kbd "greater") "firefox")
(define-key *root-map* (kbd "aring") "zathura")
(define-key *root-map* (kbd "c") "chromium")
(define-key *root-map* (kbd "C-less") "terminal")
(define-key *root-map* (kbd "C-greater") "firefox")
(define-key *root-map* (kbd "C-aring") "zathura")
(define-key *root-map* (kbd "C-c") "chromium")
(define-key *root-map* (kbd "C-f") "surf")
